...
def parse_args():
    ...
    parser.add_argument(
        "--num_workers", type=int, default=15,
...
OPENROUTER_API_KEY = "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"
...
HEADERS = {
    ...
    "X-Title": "Reasoning Benchmark"     # optional but recommended
}
    ...
    for attempt in range(MAX_RETRIES):
        try:
            ...
            if not response.text.strip():
                logging.warning("[Empty HTTP body] Retrying...")
